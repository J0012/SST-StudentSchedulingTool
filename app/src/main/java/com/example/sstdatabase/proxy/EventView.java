...
import com.example.sstdatabase.command.EditEventCommand;
...
public class EventView extends AppCompatActivity implements EventView_IF {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editButton=(FloatingActionButton) findViewById(R.id.editFab); //we must make a button finder and it will find the calendar button id we make for "View Calendar" button in our main activity
        editButton.setOnClickListener(new View.OnClickListener() { //we made a button listener function
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(EventView.this, AddEventActivity.class);
